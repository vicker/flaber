...
// OvalMC class
// ************
class as.shape.OvalMC extends as.page_content.PageElementMC
{
	// private variables
	private var mc_ref:MovieClip;				// interface for the oval mc
	...
	public function draw_it ():Void
	{
		...
		mc_ref.frame_mc.draw_oval (shape_param ["px"], shape_param ["py"], shape_param ["w"], shape_param ["h"],
	...
	public function properties_function ():Void
	{
		...
		_root.window_mc.set_window_data ("Oval Properties Window", 520, 240, "lib_properties_oval");
	...
	public function set_data_xml (x:XMLNode):Void
	{
		...
		// however this is the not the case for fill~
		shape_param ["px"] = 0;
		shape_param ["py"] = 0;
		shape_param ["w"] = 100;
		shape_param ["h"] = 50;
	...
	public function export_xml ():XMLNode
	{
		...
		// building root node
		root_node = out_xml.createElement ("OvalMC");
		...
		if (shape_param ["fc"] != null && shape_param ["fa"] != null)
		{
			...
			temp_node_2 = out_xml.createTextNode ("0x" + shape_param ["fc"].toString (16));
			temp_node.appendChild (temp_node_2);
			root_node.appendChild (temp_node);
